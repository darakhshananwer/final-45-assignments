...
console.log("Inecuality test for string",("Apple" as string) != "Orange");
...
console.log("Inquality test for number: ",(35 as number)!=26);
...
const fruits :string[] = ["banana","mango","grapes"];
